<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"C:\code\hlbw\public/../application/admin\view\experts\experts\edit.html";i:1545034966;s:55:"C:\code\hlbw\application\admin\view\layout\default.html";i:1544409141;s:52:"C:\code\hlbw\application\admin\view\common\meta.html";i:1544409141;s:54:"C:\code\hlbw\application\admin\view\common\script.html";i:1544409141;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-name" class="control-label col-xs-12 col-sm-2"><?php echo __('Username'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-tags" data-rule="required" class="form-control" name="row[tags]" type="text"  value="<?php echo $row['tags']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-keywords" class="control-label col-xs-12 col-sm-2"><?php echo __('Keywords'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-keywords" class="form-control" name="row[eywords]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="c-chenghao" class="control-label col-xs-12 col-sm-2"><?php echo __('Chenghao'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-chenghao" class="form-control" name="row[chenghao]" type="text" value="<?php echo $row['chenghao']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-certs" class="form-control" size="50" name="row[certs]" type="text" value="<?php echo $row['certs']; ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-gains" class="form-control" name="row[gains]"><?php echo $row['gains']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-content" class="control-label col-xs-12 col-sm-2"><?php echo __('Abstract'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-content" class="form-control editor" name="row[content]"><?php echo $row['content']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
