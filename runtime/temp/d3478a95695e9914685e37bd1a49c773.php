<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"C:\code\hlbw\public/../application/admin\view\news\banner\edit.html";i:1545048639;s:55:"C:\code\hlbw\application\admin\view\layout\default.html";i:1544409141;s:52:"C:\code\hlbw\application\admin\view\common\meta.html";i:1544409141;s:54:"C:\code\hlbw\application\admin\view\common\script.html";i:1544409141;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-sign" class="control-label col-xs-12 col-sm-2">APP识别标记:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo $signList; ?>
        </div>
    </div>
    <div class="form-group">
        <label for="c-options" class="control-label col-xs-12 col-sm-2">APP标记参数:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-options" class="form-control" name="row[options]" value="<?php echo $row['options']; ?>">
            注意：参数格式 a=1|b=2|c=ni|d=ds  多个参数之间|分隔
        </div>
    </div>
